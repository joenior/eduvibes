        ...
        <form action="<?php echo e(route('admin.tests.update', $test->id)); ?>" method="POST">
            ...
            <div class="form-group <?php echo e($errors->has('published') ? 'has-error' : ''); ?>">
                ...
                <select name="published" class="form-control" id="published">
                    <option <?php echo e($test->published == 1 ? 'selected' : null); ?> value="1">Active</option>
                    <option <?php echo e($test->published == 0 ? 'selected' : null); ?> value="0">In Active</option>
                </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\lms-project\resources\views/admin/tests/edit.blade.php ENDPATH**/ ?>